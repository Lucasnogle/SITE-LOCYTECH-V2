...
const Services = () => {
    ...
    return (
        <section id="services" className="py-24 bg-[#fdfbf6] dark:bg-[#020617] relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-100/50 dark:bg-blue-500/10 rounded-full blur-[100px] pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-yellow-100/50 dark:bg-purple-500/10 rounded-full blur-[100px] pointer-events-none"></div>
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <h2 className="text-4xl md:text-5xl font-display font-bold text-darkblue dark:text-white mb-6">
                        Soluções <span className="text-gradient-blue">Sob Medida</span>
                    </h2>
                ...
                >
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="bg-white dark:bg-white/5 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-50 dark:border-white/10 group relative overflow-hidden"
                        >
                            ...
                            <h3 className="text-xl font-bold text-darkblue dark:text-white mb-3 group-hover:text-primary transition-colors">{service.title}</h3>
            ...
            <WaveDivider lightFill="#ffffff" darkFill="#020617" type="curve-center" />
        </section>
    );
};
